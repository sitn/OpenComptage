...
class Class(models.Model):
    ...
    tabs_to_delete = models.CharField(max_length=90)
    to_be_converted = models.BooleanField()
    cat_00 = models.SmallIntegerField()
    cat_01 = models.SmallIntegerField()
    cat_02 = models.SmallIntegerField()
    cat_03 = models.SmallIntegerField()
    cat_04 = models.SmallIntegerField()
    cat_05 = models.SmallIntegerField()
    cat_06 = models.SmallIntegerField()
    cat_07 = models.SmallIntegerField()
    cat_08 = models.SmallIntegerField()
    cat_09 = models.SmallIntegerField()
    cat_10 = models.SmallIntegerField()
    cat_11 = models.SmallIntegerField()
    cat_12 = models.SmallIntegerField()
    cat_13 = models.SmallIntegerField()
    cat_14 = models.SmallIntegerField()
    cat_15 = models.SmallIntegerField()
    cat_16 = models.SmallIntegerField()
    cat_17 = models.SmallIntegerField()
    cat_18 = models.SmallIntegerField()
    cat_19 = models.SmallIntegerField()
