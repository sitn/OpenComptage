...
class Class(models.Model):
    ...
    tabs_to_delete = ArrayField(models.CharField(max_length=90, null=True))
    ...
    cat_02 = models.SmallIntegerField(default=0)
    cat_03 = models.SmallIntegerField(default=0)
    cat_04 = models.SmallIntegerField(default=0)
    cat_05 = models.SmallIntegerField(default=0)
    cat_06 = models.SmallIntegerField(default=0)
    cat_07 = models.SmallIntegerField(default=0)
    cat_08 = models.SmallIntegerField(default=0)
    cat_09 = models.SmallIntegerField(default=0)
    cat_10 = models.SmallIntegerField(default=0)
    cat_11 = models.SmallIntegerField(default=0)
    cat_12 = models.SmallIntegerField(default=0)
    cat_13 = models.SmallIntegerField(default=0)
    cat_14 = models.SmallIntegerField(default=0)
    cat_15 = models.SmallIntegerField(default=0)
    cat_16 = models.SmallIntegerField(default=0)
    cat_17 = models.SmallIntegerField(default=0)
    cat_18 = models.SmallIntegerField(default=0)
    cat_19 = models.SmallIntegerField(default=0)
